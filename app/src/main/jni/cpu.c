...
#include <jni.h>
  ...
  const unsigned char ADDRESS_MODE_ACCUMULATOR = 0;
  const unsigned char ADDRESS_MODE_ABSOLUTE = 1;
  const unsigned char ADDRESS_MODE_ABSOLUTE_X_INDEXED = 2;
  const unsigned char ADDRESS_MODE_ABSOLUTE_Y_INDEXED = 3;
  const unsigned char ADDRESS_MODE_IMMEDIATE = 4;
  const unsigned char ADDRESS_MODE_IMPLIED = 5;
  const unsigned char ADDRESS_MODE_INDIRECT = 6;
  const unsigned char ADDRESS_MODE_X_INDEXED_INDIRECT = 7;
  const unsigned char ADDRESS_MODE_INDIRECT_Y_INDEXED = 8;
  const unsigned char ADDRESS_MODE_RELATIVE = 9;
  const unsigned char ADDRESS_MODE_ZERO_PAGE = 10;
  const unsigned char ADDRESS_MODE_ZERO_PAGE_X_INDEXED = 11;
  const unsigned char ADDRESS_MODE_ZERO_PAGE_Y_INDEXED = 12;
